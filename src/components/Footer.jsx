      ...
      <div className="mx-auto max-w-7xl px-6 md:px-10 pt-20 pb-10">
        <div className="grid grid-cols-1 md:grid-cols-[1.4fr_.8fr_.8fr_1fr] gap-12 pb-14 border-b border-white/10">
          ...
          <div>
            ...
            />
            <p className="mt-5 text-[14px] leading-relaxed text-white/80 max-w-[32ch]">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a href="mailto:atxbaselimited@gmail.com" className="text-[14.5px] text-white/70 hover:text-white transition-colors">
        ...
        {/* bottom bar */}
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8 text-[13px] text-white/80">
